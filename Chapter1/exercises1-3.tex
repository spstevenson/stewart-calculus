...
\end{center}
		...
		\item 
			\begin{enumerate}
				...
				$f(1) = (1^2 - \frac{2^1}{1000})= 1 - \frac{2}{1000} = 1 - 0.002 = 0.998$
				
				$f(0.8) = (0.8^2 - \frac{2^{0.8}}{1000}) = 0.64 - \frac{1.7411011265922483}{1000}$
				$= 0.6382588988734077517$
				
				$f(0.6) = (0.6^2 - \frac{2^{0.6}}{1000}) = 0.36 - \frac{1.5157165665103981}{1000}$
				$ = 0.3584842834334896$
				
				$f(0.4) = (0.4^2 - \frac{2^{0.4}}{1000}) = 0.16 - \frac{1.3195079107728943}{1000}$
				$ = 0.1586804920892271$
				
				$f(0.2) = (0.2^2 - \frac{2^{0.2}}{1000}) = 0.04 - \frac{1.148698354997035}{1000}$
				$ = 0.038851301645003$
				
				$f(0.1) = (0.1^2 - \frac{2^{0.1}}{1000}) = 0.01 - \frac{1.0717734625362932}{1000}$
				$ = 0.0089282265374637$
				
				$f(0.05) = (0.05^2 - \frac{2^{0.05}}{1000} = 0.0025 - \frac{1.0352649238413775}{1000}$
				$= 0.0014647350761586$
				...
				$f(0.04)  = (0.04^2 - \frac{2^{0.04}}{1000} = 0.0016 - \frac{1.0281138266560665}{1000}$
				$ = 0.0005718861733439$
				
				$f(0.02) = (0.02^2 - \frac{2^{0.02}}{1000} = 0.0004 - \frac{1.0139594797900291}{1000}$
				$ = -0.00061395947979$
				
				$f(0.01) = (0.01^2 - \frac{2^{0.01}}{1000} = 0.0001 - \frac{1.0069555500567188}{1000}$
				$ = $
			\end{enumerate}
