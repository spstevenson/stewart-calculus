...
\end{center}
			...
			\item 	$\lim \limits _{h \to 0} \frac{(2 + h)^2 - 32}{h}$
			
			$h = \pm 0.5, \pm 0.1, \pm 0.01, \pm 0.001, \pm 0.0001$
			
			$$f(0.5) = \frac{(2 + 0.5)^2 -32}{0.5} = \frac{2.5^2 - 32}{0.5} = \frac{6.25 - 32}{0.5} = \frac{-25.75}{0.5} = -51.5$$
			
			$$f(0.1) = \frac{(2 + 0.1)^2 - 32}{0.1} = \frac{2.1^2 -32}{0.1} = \frac{4.41 - 32}{0.1} = \frac{-27.59}{0.1} = -275.9$$
			
			$$f(0.01) = \frac{(2 + 0.01)^2 - 32}{0.01} = \frac{2.01^2 - 32}{0.01} = \frac{4.0401 - 32}{0.01} = \frac{-27.9599}{0.01} = -2795.99$$
